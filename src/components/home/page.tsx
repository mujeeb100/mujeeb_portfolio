...
//        <section id="about" className="px-6 md:px-20 py-20 bg-white">
        ...
        <section id="home" className="flex flex-col-reverse lg:flex-row items-center justify-between px-8 lg:px-32 py-20 min-h-screen ">
          <div className="max-w-xl">
            <h1 className="text-4xl lg:text-5xl font-bold mb-4">
              Hi, I m <span className="text-blue-600">Mujeeb Ansari</span>
            </h1>
            <h2 className="text-xl font-medium text-gray-700 mb-6">
             Front End Developer
            </h2>
           <p className="text-gray-500 mb-8">
  Building responsive and interactive frontend interfaces using modern technologies.
  <br />
